...
$_SESSION['profile_pic'] = $profile_pics;
  ...
  elseif ($rand == 2) {
      ...
      $query = mysqli_query($con,"INSERT INTO users(first_name,last_name,username,email,password,signup_date,profile_pic,num_post,num_likes,num_follower,follow_array) VALUES('$fname','$lname','$username','$em','$psd','$date','$profile_pics','0','0','0',',')");
