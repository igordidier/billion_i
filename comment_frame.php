...
<head>
	<title></title>
	<link rel="stylesheet" type="text/css" href="assets/css/index.css?sd">
</head>
<body>
	...
	if($count != 0){
		while($comment = mysqli_fetch_array($get_comments)){
			...
			<div class="comment_section">
				<a href="<?= $posted_by ?>" target="_parent"><img  class="profile_pic_comment"src="<?= $user_obj->getProfilePic(); ?>" title="<?= $posted_by ?>" style="float:left;" height="30px"></a>
